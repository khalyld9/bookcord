...
export function MobileNav({
  ...
  return (
    <>
      <header className="sticky top-0 z-50 flex h-14 items-center justify-between border-b border-border bg-card/85 px-4 backdrop-blur min-[480px]:hidden">
      ...
      {open && (
        <div
          className="fixed inset-0 z-[60] min-[480px]:hidden"
          role="dialog"
          aria-modal="true"
